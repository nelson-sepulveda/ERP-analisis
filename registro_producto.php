      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Registro Producto</h2>
            </div>
          </header>
                            ...
                            <div class="col-lg-6">
                              <div class="card">
                                ...
                                <div class="card-body">
                                  ...
                                  <form id="producto1" class="form-horizontal">
                                    <div class="form-group row">
                                      <label class="col-sm-3 form-control-label">Nombre</label>
                                      <div class="col-sm-9">
                                        <input id="nombre_producto" type="text" placeholder="Nombre " name="nombre_producto" class="form-control form-control-success"><small class="form-text">Camisa, Pantalon, Vestido.</small>
                                      </div>
                                    </div>
                                    <div class="form-group row">
                                      <label class="col-sm-3 form-control-label">Color</label>
                                      <div class="col-sm-9">
                                        <input id="color_producto" type="text" placeholder="Color" name="color_producto" class="form-control form-control-warning"><small class="form-text">Amarillo, verde, azul.</small>
                                      </div>
                                    </div>
                                       <div class="form-group row">
                                      <label class="col-sm-3 form-control-label">Tipo de Tela</label>
                                      <div class="col-sm-9">
                                        <input id="tela_producto" name="tela_producto" type="text" placeholder="tipo de tela" class="form-control form-control-warning"><small class="form-text">Licra, Jean, Franela.</small>
                                      </div>
                                    </div>
                                       <div class="form-group row">
                                      <label class="col-sm-3 form-control-label">proveedor</label>
                                      <div class="col-sm-9">
                                      <?php include('controller/mostrar_proveedores.php'); ?>
                                      </div>
                                    </div>
                                  </form> <!-- formulario 1  -->
                                </div>
                            ...
                            <div class="col-lg-6">
                              <div class="card">
                                ...
                                <div class="card-body">
                                  ...
                                  <form id="producto2" class="form-horizontal">
                                    <div class="form-group row">
                                      <label class="col-sm-3 form-control-label">S</label>
                                      <div class="col-sm-9">
                                        <input id="talla_s" name="talla_s" type="text" placeholder="Cantidad S " class="form-control form-control-success"><small class="form-text"></small>
                                      </div>
                                    </div>
                                    <div class="form-group row">
                                      <label class="col-sm-3 form-control-label">M</label>
                                      <div class="col-sm-9">
                                        <input id="talla_m"name="talla_m" type="text" placeholder="Cantidad M" class="form-control form-control-warning"><small class="form-text"></small>
                                      </div>
                                    </div>
                                       <div class="form-group row">
                                      <label class="col-sm-3 form-control-label">L</label>
                                      <div class="col-sm-9">
                                        <input id="talla_l" name="talla_l" type="text" placeholder="Cantidad L" class="form-control form-control-warning"><small class="form-text"></small>
                                      </div>
                                    </div>
                                       <div class="form-group row">
                                      <label class="col-sm-3 form-control-label">XL</label>
                                      <div class="col-sm-9">
                                        <input id="talla_xl" name="talla_xl" type="text" placeholder="Cantidad XL" class="form-control form-control-warning"><small class="form-text"></small>
                                      </div>
                                    </div>
                                       <div class="form-group row">
                                      <label class="col-sm-3 form-control-label">XXL</label>
                                      <div class="col-sm-9">
                                        <input id="talla_xxl" name="talla_xxl" type="text" placeholder="Cantidad XXL" class="form-control form-control-warning"><small class="form-text"></small>
                                      </div>
                                    </div>
                                      
                                       <div class="form-group">
                                      <input type="submit" id="productoG" value="Guardar" class="mx-sm-3 btn btn-primary">
                                    </div><br>
